...
const AIVeterinaryAssistant = lazy(() => import("@/pages/AIVeterinaryAssistant"));
...
function PageFallback() {
  return (
    <div className="mx-auto max-w-[1280px] px-4 md:px-6 lg:px-12 xl:px-24 py-10 md:py-16">
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "animals/:id", element: <AnimalDetails /> },
          { path: "predictions", element: <DiseasePrediction /> },
          { path: "pets", element: <PetRecords /> },
          { path: "pets/:id", element: <PetDetails /> },
          { path: "vaccinations", element: <Vaccinations /> },
          { path: "care-guide", element: <CareGuide /> },
          { path: "nearby", element: <NearbyServices /> },
          { path: "ai-assistant", element: <AIVeterinaryAssistant /> },
        ],
      },
